...
Open the <a href="https://code.visualstudio.com/docs/editor/extension-gallery" target="blank"> [extension marketplace]</a>[vscode-docs-extmarket] by clicking on the _Extensions_ icon in the <a href="https://code.visualstudio.com/docs/getstarted/userinterface#_activity-bar" target="blank"> [_Activity Bar_] </a> [vscode-docs-ui-actbar]. Search for `Sypher` and click on the <kbd>Install</kbd> button.
